    ...
    return (
        ...
        >
            <div className="flex flex-col gap-4 md:gap-4 items-center justify-center w-full md:max-w-9/12">
                <motion.a
                    href="https://github.com/JuliCode07"
                ...
                >
                    ...
                    >
                        ...
                        <i className="ri-arrow-right-line rotate-90 group-hover:scale-110 group-hover:translate-y-1 transition duration-400"></i>
                    </a>
                    <a
                        href="https://github.com/Julicode07/FrontendProjects"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex gap-2 items-center justify-center bg-black text-white text-base font-semibold py-2 px-4 rounded-full w-52 h-12"
                    >
