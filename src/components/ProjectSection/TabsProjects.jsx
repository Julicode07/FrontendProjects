                        ...
                        >
                            <div className="relative h-52 w-full cursor-pointer group">
                                <img
                                    ...
                                    src={"/images/" + project.repoName + ".webp"}
                                />
                                <div className="hidden sm:block absolute inset-0 bg-gradient-to-t from-black to-transparent rounded-xl opacity-0 group-hover:opacity-100 group-hover:scale-110 group-hover:rotate-1 group-hover:-translate-y-2 transition-all duration-300">
                                    {/* Buttons */}
